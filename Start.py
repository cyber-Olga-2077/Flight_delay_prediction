...
subprocess.run(["python", "Step6_best_model_test.py"])
print("Step6_best_model_test.py finished")
subprocess.run(["python", "Step7_predict_examples.py"])
print("Step7_predict_examples.py finished")
